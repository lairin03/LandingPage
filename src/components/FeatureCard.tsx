...
export default function FeatureCard({ title, description, accent, image }: FeatureCardProps) {
  return (
    <div className="glass-panel rounded-[2rem] border border-white/10 p-8 shadow-soft transition hover:-translate-y-1 hover:border-cyan-300/25 hover:bg-white/10">
      <img src={image} alt={title} className="w-full h-48 object-cover rounded-[1.5rem] mb-6" />
